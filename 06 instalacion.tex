...
\begin{tcolorbox}[title=Instalación con BIOS: {\color{red}\ttfamily grub}]
\begin{lstlisting}[style=bashstyle]
...
\begin{lstlisting}[style=bashstyle]
pacstrap -K /mnt base base-devel linux linux-firmware sudo ntfs-3g networkmanager curl aria2 zsh neovim grub efibootmgr sddm plasma openssh git
\end{lstlisting}
\end{tcolorbox}
